...
from .views import (FeeView, BillViewSet, PaymentViewSet,
                     student_bills, payment_created_by_user, inititate_payment, success_url, cancel_url
)
...
urlpatterns = [
    ...
    path('online-payment/', inititate_payment, name='online-payment'),
    path('success-payment/', success_url, name='success-url'),
    path('cancel-payment/', cancel_url, name='cancel-url'),
]
